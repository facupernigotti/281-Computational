...
function [r,w,K,A,u,c,V,g,dV_Upwind,dVf,dVb,If,Ib,I0] = compute_steady_state_aiyagari()
...
v0 = utility(1+0.01*aa + zz*1.5,ggamma) ;
...
for ir=1:Ir
    ...
    for n=1:maxit
        ...
        dVf(I,:) = 0; %will never be used, but impose state constraint a<=amax just in case
        ...
        u = utility(c, ggamma); %I have to redefine utility here to account for gamma=1
